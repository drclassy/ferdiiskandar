    ...
    <div className="fi-page-about fi-about-dossier" id="about-page">
      ...
      <main className="fi-about-dossier-shell" id="main-content">
        ...
        <div className="fi-about-main">
          <header className="fi-about-hero" id="about-foreword">
            ...
            <aside className="fi-about-portrait-panel" aria-label="Founder portrait">
              ...
              <blockquote className="fi-about-quote">
                ...
                <p>
                  Teknologi tidak seharusnya bersaing dengan care untuk merebut perhatian.
                  Ia seharusnya membuat signal lebih jelas, judgment lebih mantap, dan tanggung jawab lebih sulit dihindari.
                </p>
          ...
          <section aria-labelledby="about-registry-title" className="fi-about-registry" id="about-registry">
          ...
          <section aria-labelledby="about-articles-title" className="fi-about-articles" id="about-articles">
          ...
          <section aria-labelledby="about-bridge-title" className="fi-about-bridge" id="about-bridge">
