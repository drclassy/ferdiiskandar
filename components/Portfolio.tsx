  ...
  return (
    ...
    >
      ...
      <div className="fi-dossier-main">
        ...
        >
          ...
          <div className="fi-dossier-titleblock">
            ...
            <p>
              Dari healthcare systems dan education systems hingga workforce systems dan
              digital experience yang berhadapan langsung dengan publik, setiap system
              dalam registry ini dirancang untuk menjawab masalah operasional nyata dengan
              accountability, clarity, dan manusia tetap di pusatnya.
            </p>
          ...
          <blockquote className="fi-dossier-quote">
            ...
            <p>
              Teknologi bukan tujuan akhirnya. Yang menjadi tujuan adalah judgment yang
              lebih baik, koordinasi yang lebih jernih, dan systems yang lebih layak
              dipercaya.
            </p>
        ...
        >
          ...
          >
            ...
            <div aria-hidden="true" className="fi-feature-illustration">
              <svg viewBox="0 0 420 310" fill="none" xmlns="http://www.w3.org/2000/svg" style={{width:'100%',height:'100%',opacity:0.55}}>
                <rect x="40" y="30" width="340" height="240" rx="8" stroke="#6b5a3e" strokeWidth="1.2" fill="none"/>
                ...
                <rect x="220" y="90" width="130" height="130" rx="6" fill="#aa8548" opacity="0.06" stroke="#aa8548" strokeWidth="0.8"/>
                ...
                <rect x="232" y="170" width="106" height="28" rx="4" fill="#173d67" opacity="0.15"/>
                <text x="285" y="189" textAnchor="middle" fontSize="10" fill="#173d67" opacity="0.7" fontFamily="Georgia, serif">Verify</text>
              </svg>
            </div>
          </motion.article>
          ...
          >
            <div className="fi-feature-copy">
              ...
              <h3>Sentra Assist</h3>
              <p className="fi-feature-subtitle">
                AI Chrome Side Panel for Full EMR Completion
              </p>
              <p>
                Sentra Assist adalah Chrome Side Panel berbasis AI yang membaca dokumen
                klinis, melakukan ekstraksi OCR, dan menerapkan algoritma field-matching
                probabilistik untuk membantu penyelesaian formulir EMR secara end-to-end
                dengan clinician review.
              </p>
              <div className="fi-feature-status">
                <small>Status</small>
                <b className="is-testing">Sedang Diuji</b>
            ...
            <div aria-hidden="true" className="fi-feature-illustration fi-assist-visual fi-sentra-assist-sketch">
              <svg viewBox="0 0 420 310" fill="none" xmlns="http://www.w3.org/2000/svg" style={{width:'100%',height:'100%',opacity:0.55}}>
                <rect x="20" y="20" width="260" height="270" rx="6" stroke="#6b5a3e" strokeWidth="1" fill="none"/>
                ...
                <line x1="290" y1="20" x2="290" y2="290" stroke="#aa8548" strokeWidth="0.8" strokeDasharray="4 3" opacity="0.5"/>
                <rect x="296" y="20" width="110" height="270" rx="6" stroke="#aa8548" strokeWidth="1.2" fill="rgba(170,133,72,0.04)"/>
                ...
                <text x="349" y="145" textAnchor="middle" fontSize="9" fill="#173d67" opacity="0.8" fontFamily="Georgia,serif">AI Fill</text>
                <path d="M 200 160 L 296 140" stroke="#aa8548" strokeWidth="1" strokeDasharray="3 2" opacity="0.6"/>
              </svg>
            </div>
          </motion.article>
        </motion.section>
        ...
        >
          <div aria-hidden="true" className="fi-hands-card">
            <svg viewBox="0 0 180 120" fill="none" xmlns="http://www.w3.org/2000/svg" style={{width:'100%',opacity:0.45}}>
              <path d="M 40 80 Q 60 40 90 60 Q 120 80 140 40" stroke="#aa8548" strokeWidth="1.5" fill="none" strokeLinecap="round"/>
              <circle cx="90" cy="60" r="18" stroke="#6b5a3e" strokeWidth="1" fill="none" opacity="0.3"/>
          ...
          <blockquote>
            <span aria-hidden="true">&ldquo;</span>
            <p>
              Sistem kami dirancang bersama clinicians dan patients. Trust mereka harus
              dibangun, bukan diasumsikan.
            </p>
        ...
        >
          ...
          <motion.div
            ...
            transition={shouldReduce ? { staggerChildren: 0, delayChildren: 0 } : undefined}
          >
            <motion.article className="fi-registry-column" variants={mv?.fadeUp} transition={shouldReduce ? { duration: 0 } : transitions.medium}>
              <h4>
                <span className="dot testing"></span>Sedang Diuji · 6
              </h4>
              <ul>
                <li><strong>AADI</strong><small>Autonomous Artificial Diagnostic Intelligence</small></li>
                <li><strong>Audrey</strong><small>Voice-First Clinical Intelligence</small></li>
                <li><strong>Intelligence Dashboard</strong><small>Unified Clinical Operations Platform</small></li>
                <li><strong>Sentra Assist</strong><small>AI Chrome Side Panel for EMR Automation</small></li>
                <li><strong>Telemedicine</strong><small>Remote Clinical Consultation</small></li>
                <li><strong>ReferraLink</strong><small>Awareness-Intelligence Protocol</small></li>
              </ul>
            </motion.article>
            <motion.article className="fi-registry-column" variants={mv?.fadeUp} transition={shouldReduce ? { duration: 0 } : transitions.medium}>
              <h4>
              ...
              <ul>
                <li><strong>Med-Cognitive</strong><small>Neural Memory Architecture for Clinical AI</small></li>
              </ul>
              <h4 className="mt">
                <span className="dot inbuild"></span>Sedang Dibangun · 11
              </h4>
              <ul>
                <li><strong>MELLY</strong><small>Hyper-Personalized Augmented Virtual Agent</small></li>
                <li><strong>Melinda Dashboard</strong><small>Zero-Friction Interoperability Platform</small></li>
                <li><strong>Melinda Shield</strong><small>Cognitive Cybersecurity Infrastructure</small></li>
                <li><strong>Autonomous Admission</strong><small>Admission &amp; Journey Tracking</small></li>
                <li><strong>Smart Triage</strong><small>Pediatric &amp; Maternal Algorithmic Assessment</small></li>
              </ul>
            </motion.article>
            <motion.article className="fi-registry-column" variants={mv?.fadeUp} transition={shouldReduce ? { duration: 0 } : transitions.medium}>
              <h4>
              ...
              <ul>
                <li><strong>Proactive Care Navigator</strong><small>Post-Partum &amp; Preventive Monitoring</small></li>
                <li><strong>Ambient Scribe</strong><small>Clinical Voice-to-EMR Engine</small></li>
                <li><strong>Critical Alert System</strong><small>Proactive NICU &amp; Telemetry Intelligence</small></li>
                <li><strong>Predictive Bed Management</strong><small>Autonomous Turnaround Orchestration</small></li>
                <li><strong>AI Coding Auditor</strong><small>Clinical Coding &amp; Claim Defense</small></li>
                <li><strong>OR Orchestrator</strong><small>Smart Operating Room Logistics</small></li>
              </ul>
            </motion.article>
            <motion.article className="fi-registry-column" variants={mv?.fadeUp} transition={shouldReduce ? { duration: 0 } : transitions.medium}>
              <h4>
              ...
              <ul>
                <li><strong>POGS</strong><small>Pregnancy Observation Global System</small></li>
                <li><strong>CDOS</strong><small>Clinical Decision Orchestration System</small></li>
                <li><strong>TRIAGE</strong><small>Severity Scoring &amp; Predictive Triage Engine</small></li>
                <li><strong>PREDICTION</strong><small>Predictive Analytics Engine</small></li>
              </ul>
            </motion.article>
          </motion.div>
          <p className="fi-registry-boundary">
            <strong>Clinical boundary:</strong> Sentra systems are designed as
            decision-support, workflow intelligence, and care coordination infrastructure.
      ...
      >
        ...
        <section>
          <h3><span className="dot testing"></span>Sedang Diuji · 6</h3>
          <ul>
            <li>AADI</li><li>Audrey</li><li>Intelligence Dashboard</li>
            <li>Sentra Assist</li><li>Telemedicine</li><li>ReferraLink</li>
          </ul>
        </section>
        <section>
          <h3><span className="dot built"></span>Sudah Dibangun · 1</h3>
          <ul><li>Med-Cognitive</li></ul>
        </section>
        <section>
          <h3><span className="dot inbuild"></span>Sedang Dibangun · 11</h3>
          <ul>
            <li>MELLY</li><li>Melinda Dashboard</li><li>Melinda Shield</li>
            <li>Autonomous Admission</li><li>Smart Triage</li>
            <li>Proactive Care Navigator</li><li>Ambient Scribe</li>
            <li>Critical Alert System</li><li>Predictive Bed Management</li>
            <li>AI Coding Auditor</li><li>OR Orchestrator</li>
          </ul>
        </section>
        <section id="registry-roadmap">
          <h3><span className="dot planned"></span>Akan Dibangun · 4</h3>
          <ul>
            <li>POGS</li><li>CDOS</li><li>TRIAGE</li><li>PREDICTION</li>
          </ul>
        </section>
      </motion.aside>
    </section>
