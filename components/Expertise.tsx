    ...
    >
      ...
      >
        ...
        >
          ...
          <h2 className="fi-thinking-title" id="thinking-stack-title">The Thinking Stack</h2>
          <div aria-hidden="true" className="fi-thinking-title-rule"><span></span></div>
          <p className="fi-thinking-pullquote">
            AI should not make healthcare louder.
            <br />It should make healthcare clearer,
            <br />calmer, and more accountable.
          </p>
        </motion.div>
        <motion.div
        ...
        >
          <p>The Thinking Stack adalah open orchestration field untuk membangun responsible clinical intelligence.</p>
          <p>Ia menyelaraskan multidisciplinary expertise lintas peran dan systems, dirancang bukan sekadar sebagai pipeline untuk mengotomasi, melainkan sebagai system untuk menalar, merefleksikan, dan mengangkat human judgment.</p>
        </motion.div>
        <motion.aside
        ...
        >
          <div>
            ...
            <p>Clarity over volume.<br />Accountability over speed.</p>
          </div>
          <div>
            <strong>Design</strong>
            <p>Human-centered orchestration.<br />Transparent by design.</p>
          </div>
          <div>
      ...
      <div className="fi-thinking-orchestration">
        <motion.aside
          ...
          transition={shouldReduce ? { duration: 0 } : transitions.medium}
        >
          <p>An open orchestration field inspired by Langflow—translated into an editorial system.</p>
          <span aria-hidden="true"></span>
          <p>Setiap peran menyumbang kemampuan reasoning yang berbeda.</p>
          <span aria-hidden="true"></span>
          <p>Bersama-sama, semuanya membentuk arsitektur deliberatif untuk clinical intelligence.</p>
          <b aria-hidden="true">✣</b>
        </motion.aside>
        ...
        >
          ...
          {thinkingNodes.map((node, i) => (
            <motion.article
              ...
              transition={shouldReduce ? { duration: 0 } : { ...transitions.dramatic, delay: i * 0.08 }}
            >
              <span>{node.label}</span>
              <h3>
                {node.title.split('\n').map((line, j) => (
                  <span key={j}>{line}{j < node.title.split('\n').length - 1 ? <br /> : ''}</span>
                ))}
              </h3>
              <p>{node.desc}</p>
            </motion.article>
      ...
      <motion.footer
        ...
        transition={shouldReduce ? { duration: 0 } : { ...transitions.medium, delay: 0.1 }}
      >
        <div><strong>Fig. 02.01</strong></div>
        <div><em>The Thinking Stack orchestration field.<br />Peran-peran dihubungkan oleh tujuan, bukan sekadar proses.</em></div>
        <div><strong>Source</strong><span>Founder Notes Lab</span></div>
        <div><strong>Note</strong><span>Bukan sekadar workflow.<br />Sebuah cara berpikir.</span></div>
        <div><strong>Status</strong><span>Terus disempurnakan</span></div>
        <div><strong>Last Updated</strong><span>{thinkingMeta.lastUpdatedLabel}</span></div>
        <div aria-hidden="true" className="fi-thinking-ornament">✧</div>
      </motion.footer>
