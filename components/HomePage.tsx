      ...
      <main className="fi-shell" id="main-content">
        ...
        <section aria-labelledby="home-dossier-title" className="fi-home-preface">
          <div className="fi-home-preface-head">
            ...
            <div>
              <h2 id="home-dossier-title">A homepage that reads like an operating brief, not a brochure.</h2>
              <p>
          ...
          <div className="fi-home-preface-grid">
            <article className="fi-home-preface-card">
              ...
              <p>
                Built around clinical responsibility, public trust, and founder-led systems
                thinking rather than generic personal-brand signaling.
              </p>
            </article>
