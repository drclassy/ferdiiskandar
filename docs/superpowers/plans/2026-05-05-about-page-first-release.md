...
export const aboutSystemsBridge = {
  ...
  body:
    'The worldview on this page is not separate from the systems work. It is the operating logic behind how intelligence layers, care infrastructure, and route-ready product surfaces are designed.',
  href: '/systems',
...
export const aboutClosing = {
  ...
  body:
    'The purpose of this page is not to impress through volume, but to make the professional posture behind the work understandable. If that posture aligns with your institution, collaboration, or strategic agenda, the next step is a clear and grounded conversation.',
  href: '/contact',
...
describe('AboutPage', () => {
  it('renders the layered authority structure', () => {
    ...
    expect(
      screen.getByRole('link', { name: /open a conversation/i }),
      ...
      <main className="fi-shell fi-about-shell" id="main-content">
        ...
        <section className="fi-about-section" aria-labelledby="about-manifesto-title">
          <div className="fi-about-section-head">
            ...
            <h2 id="about-manifesto-title">Technology should strengthen judgment, not compete with it.</h2>
          </div>
...
#about-page.fi-page-about {
  background:
    radial-gradient(circle at 16% 8%, rgba(23, 61, 103, 0.08), transparent 26rem),
    var(--fi-paper);
}
