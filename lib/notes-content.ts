...
export const mediumEntries = [
  ...
  },
  {
    ...
    body:
      'Masuk sebagai artikel lanjutan yang memperlihatkan kesinambungan antara sudut pandang kepemimpinan dan disiplin system-building.',
    href: 'https://medium.com/@claudesy.id',
    cta: 'Baca di Medium',
  },
  {
    ...
    body:
      'Diletakkan sebagai bagian dari rak tulisan yang memperluas sisi humanistik dan institusional dari diskusi AI di healthcare.',
    href: 'https://medium.com/@claudesy.id',
    cta: 'Baca di Medium',
  },
] as const
...
export const notesClosing = {
  title: 'Jika sebuah tulisan terasa relevan, langkah berikutnya adalah percakapan yang lebih jernih.',
  body:
    'Halaman ini dimaksudkan sebagai rak baca yang ringkas namun jelas. Jika salah satu tulisan menyentuh agenda institusional, healthcare AI, atau arah transformasi yang sedang dihadapi, percakapan lanjutan sebaiknya dimulai dari substansi, bukan dari kebisingan presentasi.',
  primaryHref: '/#contact',
