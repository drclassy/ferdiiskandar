export const aboutHero = {
  ...
  title: 'Professional positioning, shaped for high-responsibility systems and institutional reality.',
  thesis:
...
export const aboutGlanceSections = [
  ...
  },
  {
    title: 'Affiliations',
    items: [
      'Participant, Minimax Developer Program',
      'Member, Google Developer Premium Tier',
    ],
  },
  {
    title: 'Worldview',
...
export const aboutSystemsBridge = {
  ...
  body:
    'Worldview pada halaman ini tidak terpisah dari systems work yang dibangun. Inilah logika operasional di balik bagaimana intelligence layers, care infrastructure, dan route-ready product surfaces dirancang.',
  href: '/systems',
...
export const aboutClosing = {
  ...
  body:
    'Tujuan halaman ini bukan untuk mengesankan melalui volume, melainkan untuk membuat postur profesional di balik karya ini dapat dipahami. Jika postur tersebut selaras dengan institusi, agenda kolaborasi, atau arah strategis Anda, langkah berikutnya adalah percakapan yang jelas dan membumi.',
  href: '/contact',
