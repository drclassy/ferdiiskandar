export const cvHero = {
  ...
  thesis:
    'Law before medicine. Medicine before leadership. Leadership before intelligence.',
  context:
...
export const cvPublications: PublicationItem[] = [
  {
    ...
    year: '2025 — 2026',
    tags: ['Biomimetic AI', 'Spiking Neural Networks', 'Neuro-Symbolic AI', 'Digital Twin Brain', 'Clinical Decision Support'],
    abstract:
...
export const cvCredentials = [
  ...
  { code: 'CMDC', label: 'Certified Medical Doctor Consultant', source: 'Professional Certification' },
] as const
...
export const cvGlanceSections = [
  ...
  {
    title: 'Background',
    items: ['Law & Governance', 'Clinical Medicine', 'Hospital Leadership', 'Artificial Intelligence'],
  },
] as const
