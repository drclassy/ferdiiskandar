...
export const contactCards = [
  {
    ...
    description: 'Use for cross-sector intelligence systems, institutional strategy, and founder-led collaboration.',
    href: null,
  },
  {
    label: 'Institutional Programs',
    value: 'Transformation and implementation direction',
    description: 'Use when the conversation involves healthcare, education, workforce, or public-facing digital systems.',
    href: null,
  },
  {
    label: 'Direct Contact',
    value: 'Public links and direct email',
    description: 'Selected public surfaces are listed below for direct outreach, publication, and professional contact.',
    href: null,
  },
] as const
